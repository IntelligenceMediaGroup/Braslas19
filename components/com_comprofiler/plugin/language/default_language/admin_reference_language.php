...
* @version $Id: admin_reference_language.php 1627 2011-11-02 06:04:50Z beat $
...
// cb.authortab.xml
'Provides a User Tab that shows all articles written by the user.' => 'Provides a User Tab that shows all articles written by the user.',
...
'Resend Confirmations'	=>	'Resend Confirmations',
...
'Could not send email to %s of %s users out of %s emails to send' => 'Could not send email to %s of %s users out of %s emails to send',
'Just sent %s emails to following users:' => 'Just sent %s emails to following users:',
'Still %s emails remaining to send.' => 'Still %s emails remaining to send.',
'%s emails could not be sent due to a sending error.' => '%s emails could not be sent due to a sending error.',
