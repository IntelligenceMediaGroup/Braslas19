...
* @version $Id: view.users.php 1632 2011-11-02 22:56:25Z beat $
...
?>
    <tr class="<?php echo "row$k"; ?>">
      ...
      <td><input type="checkbox" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->id; ?>" onClick="cbIsChecked(this.checked);" /></td>
      <td> <a href="#edit" onClick="return cbListItemTask( this, 'edit', null, null, 'cb', '<?php echo $i;?>' )">
...
?>
      ...
      <td width="10%"><a href="javascript: void(0);" onClick="return cbListItemTask( this, '<?php echo $task;?>', null, null, 'cb', '<?php echo $i;?>' )"><img src="<?php echo $imgpath.$img;?>" width="16" height="16" border="0" title="<?php echo $hover1; ?>" alt="<?php echo $hover1; ?>" /></a></td>
      <td width="10%"><img src="<?php echo $imgpath.$img3;?>" width="16" height="16" border="0" title="<?php echo $hover3; ?>" alt="<?php echo $hover3; ?>" /></td>
      <td width="10%"><a href="javascript: void(0);" onClick="return cbListItemTask( this, '<?php echo $task2;?>', null, null, 'cb', '<?php echo $i;?>' )"><img src="<?php echo $imgpath.$img2;?>" width="16" height="16" border="0" title="<?php echo $hover; ?>" alt="<?php echo $hover; ?>" /></a></td>      <td><?php echo $row->id; ?></td>
